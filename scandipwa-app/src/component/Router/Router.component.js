...
export const About = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "about" */ 'Route/About'));
...
/** @namespace ScandipwaApp/Component/Router/Component/withStoreRegex */
export const withStoreRegex = (path) => window.storeRegexText.concat(path);

/** @namespace ScandipwaApp/Component/Router/Component */
export class RouterComponent extends PureComponent {
     ...
     [SWITCH_ITEMS_TYPE] = [
         ...
         {
             component: <Route path={ withStoreRegex('/about') } exact render={ (props) => <About { ...props } /> } />,
             position: 14
         },
         {
